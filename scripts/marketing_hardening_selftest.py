...
cases = [
    ...
    ('binding claims a published connector tool provides a capability it does not', lambda p: p['capability_bindings'].append({'capability': 'platform_policy.read', 'system_ref': 'system://synthetic-social', 'connector_ref': 'connector://yalloha/get_property_details', 'authority': 'observe'}), 'declares that tool as'),
    ('binding to a tool the published connector does not have', lambda p: p['capability_bindings'].append({'capability': 'analytics.read_aggregate', 'system_ref': 'system://synthetic-social', 'connector_ref': 'connector://yalloha/get_everything', 'authority': 'observe'}), 'no published connector declares'),
    ('binding to a tool the published connector prohibits', lambda p: p['capability_bindings'].append({'capability': 'analytics.read_aggregate', 'system_ref': 'system://synthetic-social', 'connector_ref': 'connector://yalloha/mark_commission_paid', 'authority': 'observe'}), 'declares that tool as'),
