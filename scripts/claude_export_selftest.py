...
with tempfile.TemporaryDirectory() as td:
    ...
    expected = ['adversarial-reviewer', 'business-performance-analyst', 'corporate-development-analyst', 'long-range-planner', 'market-intelligence-analyst', 'strategy-lead']
...
print(f'PASS Claude Code adapter exports {len(expected)} subagents and guard fails closed on {sum(1 for c in cases if c[2])} authority violations')
